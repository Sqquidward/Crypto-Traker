...
public class Stock_Activity_Init {
    ...
    public Stock_Activity_Init(String symbol, String title, String image, String price, String high_24, String market_cap_rank, String low_24, String total_volume, String price_change_24h, String market_cap_change_24h, String circulating_supply, String atl, String atl_change_percentage) {
        this.symbol = symbol;
        this.title = title;
        this.image = image;
        this.price = price;
